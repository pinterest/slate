...
public class DemoResourceDef implements ResourceDefinition {
  ...
  private Map<String, EdgeDefinition> requiredInboundEdgeTypes = ImmutableMap.of("i1",
      new EdgeDefinition(DemoResourceDef.class.getCanonicalName(), 0, 1), "i2",
      new EdgeDefinition(DemoResourceDef.class.getCanonicalName(), 0, 1), "i3",
      new EdgeDefinition(DemoResourceDef.class.getCanonicalName(), 0, 1), "i4",
      new EdgeDefinition(DemoResourceDef.class.getCanonicalName(), 0, 1), "i5",
  ...
  private EdgeDefinition requiredParentEdgeTypes = new EdgeDefinition(
      DemoParentResourceDef.class.getCanonicalName(), 1, 1);
  ...
  public Resource newInstance(String id) {
    return new Resource(id, DemoResourceDef.class.getCanonicalName(), 5, 4);
  }
